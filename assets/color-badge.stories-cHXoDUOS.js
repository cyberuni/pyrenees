import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{C as e}from"./color-badge-COu62KXZ.js";import"./badge-DsBEe7Yc.js";const h={title:"components/ColorBadge",component:e,argTypes:{color:{control:"select",options:["sky","purple","cyan","green","pink","indigo","lime","steel-gray"],description:"Color variant of the badge"},children:{control:"text",description:"Content displayed inside the badge"}}},r={args:{children:"Default"}},s={args:{color:"sky",children:"Custom Class",className:"pds:px-6 pds:py-2"}},a={tags:["snapshot"],render:()=>o.jsxs("div",{className:"pds:flex pds:flex-wrap pds:gap-2",children:[o.jsx(e,{color:"sky",children:"Sky"}),o.jsx(e,{color:"purple",children:"Purple"}),o.jsx(e,{color:"cyan",children:"Cyan"}),o.jsx(e,{color:"green",children:"Green"}),o.jsx(e,{color:"pink",children:"Pink"}),o.jsx(e,{color:"indigo",children:"Indigo"}),o.jsx(e,{color:"lime",children:"Lime"}),o.jsx(e,{color:"steel-gray",children:"Steel Gray"})]})};var l,d,n;r.parameters={...r.parameters,docs:{...(l=r.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    children: 'Default'
  }
...
}`,...(m=(g=a.parameters)==null?void 0:g.docs)==null?void 0:m.source}}};const x=["Default","WithCustomClassName","AllColors"];export{a as AllColors,r as Default,s as WithCustomClassName,x as __namedExportsOrder,h as default};
