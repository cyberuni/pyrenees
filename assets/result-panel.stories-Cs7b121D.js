import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{w as A,u as j,e as h}from"./index-CIfn4WAl.js";import{r as B}from"./index-D4lIrffr.js";import{R as l}from"./themed-doc-container-23MYOY87.js";import"./_build_class_names_tagged_template-M4c5DjCo.js";import"./tw-merge-Dzlj8q8h.js";import"./index-DXMeLfcf.js";import"./iframe-C561ExEk.js";import"./index-BQQLSK9g.js";import"./index-DsJinFGm.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";const Q={component:l,parameters:{sourceLink:"components/result_panel.tsx"}},t={render(){const[c,s]=B.useState([]);return e.jsxs("div",{className:"twds-flex twds-flex-col",children:[e.jsx("button",{type:"button","data-testid":"add",className:"twds-text-primary dark:twds-text-primary-dark twds-bg-primary dark:twds-bg-black twds-rounded",onClick:()=>s(u=>[...u,{a:1}]),children:"Add Result"}),e.jsx(l,{value:JSON.stringify(c)})]})},async play({canvasElement:c}){const s=A(c),u=await s.findByTestId("add");await j.click(u);const E=await s.findByTestId("result-panel");h(E.innerText).toEqual('[{"a":1}]')}},r={render(){return e.jsx(l,{label:"Custom Label",value:JSON.stringify({a:1},null,2)})}},a={render(){return e.jsx(l,{className:"twds-bg-blue-300 twds-rounded-md twds-border-solid twds-p-2 twds-border-white",value:JSON.stringify({a:1},null,"	")})}},n={args:{elementType:"samp",value:JSON.stringify({a:1,b:2,c:3},null,"	")}},o={args:{elementType:"code",value:JSON.stringify({a:1,b:2,c:3},null,"	")}},d={args:{elementType:"kbd",value:JSON.stringify({a:1,b:2,c:3},null,"	")}};var i,m,p;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render() {
