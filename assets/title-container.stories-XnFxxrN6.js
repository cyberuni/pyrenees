import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{w as I,e as c}from"./index-CIfn4WAl.js";import"./themed-doc-container-BirptzrQ.js";import"./index-D4lIrffr.js";import{w as j}from"./with-story-swatch-B0RCFMKP.js";import{D as b}from"./dashboard-icon-CZDurs2b.js";import{T as C,H as B}from"./car-icon-BFl1wZbI.js";import"./close-button-DldS42sq.js";import"./_build_class_names_tagged_template-M4c5DjCo.js";import"./tw-merge-Dzlj8q8h.js";import"./index-DND4CyhT.js";import"./iframe-DZlMMFxQ.js";import"./index-BQQLSK9g.js";import"./index-DsJinFGm.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";import"./index-CKi3-S8O.js";const Q={title:"components/containers/TitleContainer",component:C,decorators:[j()],tags:["cat:container"]},n={args:{title:"String Title"},async play({canvasElement:t}){const a=await(await I(t)).getByRole("heading",{name:"String Title"});c(a).toBeInTheDocument()}},s={args:{title:e.jsx(B,{level:2,children:"H2 title"})},async play({canvasElement:t}){var p;const a=await(await I(t)).getByText("H2 title");c(a.nodeName).toEqual("H2"),c((p=a.parentElement)==null?void 0:p.nodeName,"parent should be div").toEqual("DIV")}},i={args:{title:"Title",description:"description"}},r={args:{title:"Title"},render(t){return e.jsx(C,{...t,description:e.jsxs("span",{children:[e.jsx("span",{className:"pds:text-red-600",children:"Custom"})," description"]})})}},o={args:{title:"Title with Icon",icon:e.jsx(b,{})}};var l,m,d;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    title: 'String Title'
  },
  async play({
...
}`,...(H=(E=o.parameters)==null?void 0:E.docs)==null?void 0:H.source}}};const U=["StringTitle","CustomTitle","WithDescription","WithCustomDescription","WithIcon"];export{s as CustomTitle,n as StringTitle,r as WithCustomDescription,i as WithDescription,o as WithIcon,U as __namedExportsOrder,Q as default};
